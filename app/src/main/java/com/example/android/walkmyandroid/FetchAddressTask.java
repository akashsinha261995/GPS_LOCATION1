    ...
    protected String doInBackground(Location... locations) {
        ...
        try {
            ...
            if(addresses == null || addresses.size() ==0){
                ...
                Log.d(TAG, String.valueOf(address.getMaxAddressLineIndex()));
            ...
            resultMessage = mContext.getString(R.string.invalid_lat_lng_used);
            ...
            resultMessage = mContext.getString(R.string.Last_Location_Unknown);
            Log.e(TAG, resultMessage, e);
        }
